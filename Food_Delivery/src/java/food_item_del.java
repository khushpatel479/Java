 ...
 * @author Acer
 */
@WebServlet(urlPatterns = {"/food_item_del"})
public class food_item_del extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
          ...
          try
          {
              ...
              if(y>0)
              {
                  ...
                  RequestDispatcher rd = request.getRequestDispatcher("adminside_fooditem_display.jsp");
